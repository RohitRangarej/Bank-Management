...
<head>
    ...
    define('bankName', 'Chit-Fund Bank','');
...
<body style="background: url(images/bg.jpg);background-size: 100%">
 <audio autoplay><source src="y.mp3" type="audio/mpeg"></audio>
<h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Rohit Rangarej | Taranpreet Singh | Vishal Habib</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
